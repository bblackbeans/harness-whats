    ...
    <div className="relative flex min-h-screen items-center justify-center bg-gray-50 px-4 dark:bg-gray-950">
      ...
      <div className="card w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Harness Admin</h1>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Plataforma SaaS de Agentes IA</p>
        </div>
